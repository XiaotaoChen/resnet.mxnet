...
def Conv_DPW(data, depth=1, stride=(1, 1), name='', idx=0, suffix='', 
             quant_mod='minmax', delay_quant=0, is_weight_perchannel=False):
    conv_dw = Conv(data, num_group=depth, num_filter=depth, kernel=(3, 3), pad=(1, 1), stride=stride, 
                   name="conv_%d_dw" % (idx), suffix=suffix, 
...
def mobilenet_int8(num_classes, alpha=1, resolution=224, 
                   quant_mod='minmax', delay_quant=0, is_weight_perchannel=False,
