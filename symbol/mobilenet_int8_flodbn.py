...
import mxnet as mx
from .quantization_int8_V2 import flod_bn, quant_fc
...
def Conv(data, num_filter=1, channel=1, kernel=(1, 1), stride=(1, 1), pad=(0, 0), num_group=1, name='', suffix='',
    ...
    bn = flod_bn(name=name, data=data,
                 # quant params
...
def mobilenet_int8_flodbn(num_classes, alpha=1, resolution=224, 
                   quant_mod='minmax', delay_quant=0, is_weight_perchannel=False, **kwargs):
